...
func addToTextp(ctxt *Link) {
  ...
  println("coelho deadcode 00 ", len(ctxt.Textp));
	textp := []*sym.Symbol{}
  ...
  println("coelho deadcode 01 ", len(ctxt.Textp));
  ...
  println("coelho deadcode 03 ", len(ctxt.Textp));
  ...
  println("coelho deadcode 04 ", len(ctxt.Textp));
}
